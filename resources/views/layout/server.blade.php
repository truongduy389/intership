...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('server') }}/mystore/css/indexProductMyStore.css">
    <link rel="stylesheet" href="{{ asset('server') }}/mystore/css/detailsProductMyStore.css">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <div class="dropdown show">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="{{Route('mystore')}}">My connect store </a>
                    </div>
                </div>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-1">
                        <div class="col-sm-6">
                            <h1 class=" ml-3 text-dark">@yield('title')</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            @yield('add')
                        </div><!-- /.col -->
